                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table  class="table" style="width:100%;text-align:center" id="example" >
                                ...
                                <tbody>
                                    @foreach ($loaitin as $ltin => $value)
                                        <tr>
                                            <td>{{ $value->maloaitin }}</td>
                                            <td>{{ $value->tenloaitin }}</td>
                                            <td>{{ $value->mota }}</td>
                                            <td><a href="{{route('ltin.edit',['id'=>$value->maloaitin])}}"><i class="fas fa-edit"></i></a>
                                            <a href="{{route('ltin.delete',['id'=>$value->maloaitin])}}"><i class="far fa-trash-alt"></i></a></td>
                                        </tr>
                                    @endforeach
                        ...
                        <!-- end table-responsive chay le di-->
