        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="breadcrumb-holder">
                    <h1 class="main-title float-left">THÊM LOẠI SẢN PHẨM</h1>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('lsp.save') }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="userName">Tên loại<span class="text-danger">*</span></label>
                                <input type="text" name="tenloai" data-parsley-trigger="change" required
