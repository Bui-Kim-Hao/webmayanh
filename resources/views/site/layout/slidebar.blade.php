    ...
    <div id="hero">
        <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
            <div class="item" style="background-image: url('{{ asset('public/frontend/imgs/slides/slide7.jpg')}}');">
            ...
            <div class="item" style="background-image: url('{{ asset('public/frontend/imgs/slides/slide2.jpg')}}');">
                <div class="container-fluid">
                    <div class="caption bg-color vertical-center text-left">
