        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
                    <!-- ============================================================= LOGO ============================================================= -->
                    <div class="logo"><a href="{{route('trangchu')}}"><img style="height: 80px" width="200px" src="{{ asset('public/uploads/product/logo.png') }}" alt=""></a></div>
                    <!-- /.logo -->
                    <!-- ============================================================= LOGO : END ============================================================= -->
                </div><!-- /.logo-holder -->
                    ...
                    <div class="search-area">
                            <div class="control-group">
                                ...
                                <form action="{{url('/tim-kiem')}}" method="GET">
                                     <input class="search-field" type="text" name="key" placeholder="Tìm kiếm..." /><a
                ...
                <div class="col-xs-12 col-sm-12 col-md-2 animate-dropdown top-cart-row">
                    ...
                    <div class="dropdown dropdown-cart"><a href="{{route('giohang.index')}}" class="dropdown-toggle lnk-cart"
                          >
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                ...
                                <div class="clearfix cart-total">
                                    ...
                                    <div class="clearfix"></div><a href="checkout.html"
    ...
    <div class="header-nav animate-dropdown">
        <div class="container">
            <div class="yamm navbar navbar-default" role="navigation">
                <div class="navbar-header"><button data-target="#mc-horizontal-menu-collapse" data-toggle="collapse"
                    ...
                    <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
                        <div class="nav-outer">
                            <ul class="nav navbar-nav">
                                <li class="active dropdown yamm-fw"><a href="{{route('trangchu')}}"
                                        class="dropdown-toggle">Trang chủ</a></li>
                                ...
                                <li class="
                                dropdown"><a href="contact.html">Shoes</a></li>
