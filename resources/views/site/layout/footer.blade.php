            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="module-heading">
                        <h4 class="module-title">Liên lạc</h4>
                    </div><!-- /.module-heading -->
                        ...
                        <ul class="toggle-footer" style="">
                            <li class="media">
                                ...
                                <div class="media-body">
                                    <p>Lưu Xá, Hồ Tùng Mậu, Ân Thi, Hưng Yên</p>
                                </div>
                            </li>
                            <li class="media">
                                <div class="pull-left"><span class="icon fa-stack fa-lg"><i
                                ...
                                <div class="media-body">
                                    <p>0383.970.335<br>+(84)383.970.335</p>
                                </div>
                            </li>
                            <li class="media">
                                <div class="pull-left"><span class="icon fa-stack fa-lg"><i
                                            class="fa fa-envelope fa-stack-1x fa-inverse"></i></span></div>
                                <div class="media-body"><span><a href="#">buikimhao10072000@gmail.com</a></span></div>
                            </li>
                        </ul>
                    </div><!-- /.module-body -->
                </div><!-- /.col -->
